export default {
  ...
  "COMMON": {
    ...
    "CHOOSE_SHARER": "Share Space, Get Rewards",
    "CHOOSE_GMAIL": "Your Personal Encrypted Mailbox",
    "EXIT": "exit",
    "DO_NOT_EXIT": "no not exit",
    "EXIT_TITLE": "Exit the program",
    "EXIT_MSG_EDEN": "There is a file currently being transferred. If you exit, the transfer will be cancelled. Are you sure you want to exit?",
    "EXIT_MSG_SHARER": "The node you are currently sharing is running. If you exit, the shared node will stop receiving the storage task assigned by the system. Do you confirm that you want to exit？",
    ...
    "REJECT_SHARE_CONFIRM": "Are you sure to reject the document？",
    "DELETE_SHARE_CONFIRM": "If you click confirm, the message will be deleted.",
    "START_USE": "Start to use",
    "USE_DAPP": "Develop DApp",
  ...
  "INPUT": {
    ...
    "STORE_BUCKET": "Select storage space",
    "MESSAGE_TITLE": "Email title",
    "NICK_NAME": "Nickname",
    "NICK_PRICE": "Nickname price"
  },
  "MODEL": {
    ...
    "EDEN_RECEIVE_NEED_PASS": " Please enter your wallet password to receive files",
    "EDEN_SHARE_NEED_PASS": " Please enter your wallet password to unlock the [Sharing] feature",
    ...
    "ABOUT": {
      ...
      "UPDATING": "Updating",
      "VERSION": "VERSION",
      "VERSION_UPDATE": "Software update",
      "VERSION_CHECK": "Check the latest version",
      "VERSION_CHECK_ERROR": "Error found",
      "VERSION_CHECKING": "Checking",
      "VERSION_IS_LATEST": "No updates",
      "VERSION_DOWNLOADING": "Downloading",
      "VERSION_INSTALL": "Restart to install"
    },
    "HELP": {
      ...
      "MAIL_INSTRUCTIONS": "G-EMAIL Userguide",
  ...
  "SIDERBAR": {
    ...
    "EDEN_TASK": "Task list",
    "EDEN_FILE_RECEIVE": "Files received",
    "EDEN_FILE_SHARE": "My sharing",
  ...
  "WALLETNEW": {
    ...
    "REPEAT_PASSWORD_ERROR": "Password error and try again:",
  ...
  "TXEDEN": {
    ...
    "AGREE_SHARE": "Agree to receive",
    "REJECT_SHARE": "Reject to receive",
    "DELETE_SHARE": "Delete document shared"
  },
  "TXSHARER": {
    "STAKE": "Stake",
    "UNSTAKE": "Unstake",
    ...
    "NONE_BINDED_TIP": "No bounded node, after the “stake” is successful, binding shared node can obtain the storage revenue.",
  ...
  "EDEN": {
    ...
    "DELETE_BUCKET_TIP2": "File“{{fileNames}}”has been shared to others, once deleted, the others cannot receive the file. ",
    ...
    "SHARE_FILE": "Share file",
    "DELETE_FILES_CONFIRM": "Are you sure to delete the files?",
    "DELETE_FILES_TIP1": "Are you sure to delete “{{fileNames}}”?",
    "DELETE_FILES_TIP2": "The file has been shared to the others, ",
    "DELETE_FILES_TIP3": "If deleted, the file will not be received by the recipient 。",
    "DELETE_FILES_TIP4": "Are you sure to delete the file selected?",
  ...
  "EDEN_FILE_SHARE": {
    ...
    "AGREE": "Accept",
    "REJECT": "Reject",
    "WAITING_AGREE": "Waiting to accept",
    "AGREED": "Received",
    "REJECTED": "Rejected",
    "DELETE_SHARE_TIP": "Are you sure to delete the selected sharing history？"
  },
  "TASK": {
    "FILE_NAME": "Filename",
    "FILE_SIZE": "File size",
    ...
    "SEND_MESSAGE_TIP": "Email sending..."
  },
  "DRIVE": {
    "CANCEL": "Cancel",
    "NEXT": "Next",
  ...
  "ERROR": {
    ...
    "SELECT_FILE": "Please select your file ",
    "FILE_CANNOT_SHARE": "This file can not be shared ",
    "CHAIN_NOT_READY": " The connection has been lost, please reconnect and try again",
  ...
  "MAIL": {
    "INBOX": "Inbox",
    "OUTBOX": "Outbox",
    "SET_RECEIVE": "Set up Inbox",
    "SET_SEND": "Set up Outbox",
    "SENDER": "From: ",
    "RECEIVER": "To: ",
    "TITLE": "Subject",
